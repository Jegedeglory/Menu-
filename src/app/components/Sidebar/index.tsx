            ...
            <div onClick={() => handleIconClick('home')}>
              ...
              >
                <path
                  ...
                  fill={selectedIcon === 'home' ? '#6F4FF2' : '#65646A'}
                />
              </svg>
            </div>
          </Link>
            ...
            <div onClick={() => handleIconClick('profile')}>
              ...
              >
                <path
                  ...
                  fill={selectedIcon === 'profile' ? '#6F4FF2' : '#65646A'}
                />
              </svg>
            </div>
          </Link>
            ...
            <div onClick={() => handleIconClick('favorite')}>
              ...
              >
                <g id="bytesize:heart">
                  <path
                    id="Vector"
                    d="M5 20C1.25 15 2.5 7.49996 8.75 4.99996C15 2.49996 18.75 7.49996 20 9.99996C21.25 7.49996 26.25 2.49996 32.5 4.99996C38.75 7.49996 38.75 15 35 20C31.25 25 20 35 20 35C20 35 8.75 25 5 20Z"
                    stroke={selectedIcon === 'settings' ? '#6F4FF2' : '#65646A'}
                    stroke-width="1.5"
          ...
          <div onClick={() => handleIconClick('sign-out')}>
            ...
            >
              <path
                ...
                fill={selectedIcon === 'sign-out' ? '#6F4FF2' : '#65646A'}
              />
            </svg>
          </div>
        </Link>
